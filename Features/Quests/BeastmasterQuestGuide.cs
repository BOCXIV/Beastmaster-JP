...
public static class BeastmasterQuestGuide
{
    ...
    [
        ...
        new(71027, "最初の相棒", "魔獣使いのジョブクエスト。"),
        new(71028, "魔獣と心を通わせる", "魔獣使いのジョブクエスト。"),
        new(71029, "ルー流調教術", "魔獣使いのジョブクエスト。"),
        new(71030, "盤上の戦い", "魔獣使いのジョブクエスト。"),
        new(71031, "姉弟子から学ぶゴブ！", "魔獣使いのジョブクエスト。"),
        new(71032, "同門の競い合い", "魔獣使いのジョブクエスト。"),
        new(71033, "贖罪の魔獣使い", "魔獣使いのジョブクエスト。"),
        new(71034, "貪食のガトラー", "魔獣使いのジョブクエスト。"),
        new(71035, "揺るぎなき絆", "魔獣使いのジョブクエスト。"),
        new(71036, "猛者の試練：高段第一盤", "魔獣使い高段試練クエスト。"),
        new(71037, "盤上の王者：高段第二盤", "魔獣使い高段試練クエスト。"),
        new(71045, "調教の道を極めし者", "魔獣使いのジョブクエスト。"),
    ];
